...
public class AdminHistory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Κωδικός", "Ονοματεπώνυμο", "Τηλέφωνο", "Περιστατικό", "Διεύθυνση", "Αρ. Ταυτότητας"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 200, 540, 190));
